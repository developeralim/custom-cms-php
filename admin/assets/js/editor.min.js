...
function uploadImage(data){
      ...
      ajax.open("POST",'http://localhost/cms/admin/ajax.php',true);
      ajax.send(formData);
      /* do all actions with this hook */
...
function mouseDown(){
      ...
      element.setAttribute('element-type','cropper');
      /* apply resize and move functionality */
      injectResizePoints(element);
      applyResize(element);
      applyMovement(element);  
      /* set resize dimension to */
      $('#crop-image #crop-left').value = `${Math.round(draw.drawMouseStartleft)}px`;
      $('#crop-image #crop-top').value = `${Math.round(draw.drawMouseStartTop)}px`;
      $('#crop-image #crop-width').value = draw.drawWidth;
      $('#crop-image #crop-height').value = draw.drawheight;
      /* set some css */
...
function drawItem(){
      ...
      if(isDrawing){
            ...
            /* set resize dimension to */
            $('#crop-image #crop-width').value = `${Math.round(draw.drawWidth)}px`;
            $('#crop-image #crop-height').value = `${Math.round(draw.drawheight)}px`;
            /* do all actions */
            draw.event = e;
